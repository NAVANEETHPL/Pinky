...
await message.client.sendMessage(message.jid, fs.readFileSync('./files/stickers/AKBOY.webp'), MessageType.sticker, { mimetype: Mimetype.webp, quoted : message.data, ptt: false})
    }
